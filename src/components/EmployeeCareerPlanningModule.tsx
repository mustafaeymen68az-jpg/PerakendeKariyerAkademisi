        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white p-6 rounded-3xl border border-gray-200 shadow-md space-y-4">
              ...
              {(() => {
                ...
                return (
                  <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2.5 w-full sm:w-auto shrink-0">
                    ...
                    <div className="bg-gradient-to-r from-emerald-600 to-teal-700 text-white p-3.5 sm:p-4 rounded-2xl shadow-md space-y-0.5 text-left sm:text-right flex-1 sm:flex-none border border-emerald-400 shrink-0">
                      <div className="text-[9px] font-mono font-black uppercase text-emerald-100 flex items-center justify-start sm:justify-end space-x-1">
                        <Sparkles className="w-3 h-3 text-amber-300 shrink-0" />
                        <span>ÖNERİLEN TERFİ HEDEFİ</span>
                      </div>
                      <div className="text-xs sm:text-sm font-black text-white">{activeEmployee.recommendedRole}</div>
                    ...
                    <div className={`p-3.5 sm:p-4 rounded-2xl shadow-md space-y-0.5 text-left sm:text-right flex-1 sm:flex-none border shrink-0 ${
                      isMatching
                      ...
                      <div className="text-[9px] font-mono font-black uppercase text-white/90 flex items-center justify-start sm:justify-end space-x-1">
                        <Target className="w-3 h-3 text-amber-300 shrink-0" />
                        <span>PLANLANAN KİŞİSEL HEDEF</span>
                      </div>
                      <div className="text-xs sm:text-sm font-black text-white">{personalGoalRole}</div>
                      <div className="text-[10px] font-mono font-bold">
                        {isMatching ? (
                          <span className="text-emerald-100 bg-emerald-900/50 px-2 py-0.5 rounded-md border border-emerald-300/40 font-black inline-block">
                            Sistemle Uyumlu ✅
                          </span>
                        ) : (
                          <span className="text-white bg-rose-950/70 px-2 py-0.5 rounded-md border border-rose-200/50 font-black inline-block">
            ...
            {(() => {
              ...
              return (
                <div className={`p-4 sm:p-5 rounded-2xl border-2 shadow-xs space-y-2.5 mt-2 transition-all ${
                  isMatching
                  ...
                  <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2 border-b border-amber-200/60 pb-2">
                    <div className="flex items-center space-x-2">
                      <Target className={`w-4 h-4 shrink-0 ${isMatching ? 'text-amber-600' : 'text-rose-600'}`} />
                    ...
                    <div className="flex items-center space-x-2">
                      {isMatching ? (
                        <span className="text-[9px] font-mono font-black px-2 py-0.5 bg-emerald-100 text-emerald-900 rounded-md border border-emerald-400">
                          Sistemle Uyumlu ✅
                        </span>
                      ) : (
                        <span className="text-[9px] font-mono font-black px-2 py-0.5 bg-rose-200 text-rose-950 rounded-md border border-rose-400 animate-pulse">
                          ⚠️ Tutarsızlık Var! (Farklı Hedef)
                        </span>
                      )}
                  ...
                  <div className="bg-white p-3.5 rounded-xl border border-gray-200 space-y-1.5 shadow-2xs">
                    ...
                    <p className="text-xs text-gray-800 italic font-medium bg-gray-50/80 p-2.5 rounded-lg border border-gray-200/80 leading-relaxed">
          ...
          <div className="bg-white p-6 rounded-3xl border border-gray-200 shadow-md space-y-5">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2 border-b border-gray-100 pb-3">
              ...
              <span className="text-[10px] font-mono font-black text-indigo-900 bg-indigo-100 px-3 py-1 rounded-full border border-indigo-300">
            ...
            <div className="flex flex-col items-center space-y-3 py-1">
              ...
              {(activeEmployee.hierarchy.ceoChain || []).map((node, index) => {
                ...
                return (
                  <React.Fragment key={node.id}>
                    <div className={`w-full p-4 rounded-2xl shadow-md flex items-center justify-between gap-3 relative border-2 ${
                      isCeo
                        ? 'bg-gradient-to-r from-amber-950 via-slate-950 to-amber-950 text-white border-amber-400 ring-2 ring-amber-400/20'
                        : index === 1
                        ...
                        <div className="relative shrink-0">
                          <img
                            ...
                            className={`w-12 h-12 rounded-xl object-cover border-2 shadow-xs ${
                              isCeo ? 'border-amber-400 ring-1 ring-amber-300' : 'border-blue-300'
                            }`}
                          />
                          {isCeo && (
                      ...
                      <span className={`text-[10px] font-mono font-extrabold px-2.5 py-1 rounded-lg border whitespace-nowrap ${
                        isCeo
              ...
              {/* 5. KADEME: MEVCUT ÇALIŞAN (SEÇİLİ PROFİL) */}
              ...
              {/* 6. KADEME: KENDİSİNE BAĞLI ÇALIŞANLAR (ALT EKİP ÜYELERİ) */}
              <div className="w-full space-y-2">
                <div className="flex items-center justify-between">
                  <h4 className="font-extrabold text-[11px] text-[#0B2A4A] uppercase tracking-wider flex items-center space-x-1.5">
                    ...
                    <span>⬇️ 6. Kademe: Kendisine Bağlı Alt Çalışanlar ({activeEmployee.hierarchy.subordinates.length} Personel)</span>
                  </h4>
